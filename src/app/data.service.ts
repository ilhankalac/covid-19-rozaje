...
export class DataService {
  ...
  dataElement: AngularFireObject<any>;
  ...
  //prettier-ignore
  getLatestDataKey(){
    this.dailyStatistics = this.firebase.list('dailyStatistics', ref=> ref.limitToLast(1));
    return this.dailyStatistics.snapshotChanges();
  }

  getLatestElement(key: string) {
    this.dataElement = this.firebase.object('dailyStatistics/' + key);
    return this.dataElement.valueChanges();
  }
